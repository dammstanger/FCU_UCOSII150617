...
#define MPU6050_NONE_DMP_DRIVER
//#define MPU6050_DMP_DRIVER


void MPUDataRead(void);
void MPU6050_RD_XYZ(short *mpug,short *mpua,short *tempt);
//void delay_ms(u16 n);
void MPU6050_BufferRead(u8* pBuffer, u8 readAddr, u16 NumByteToRead);
bool MPU6050_NoneDMPInit(void);
...
#define DEFAULT_MPU_HZ  (200)		//original 100 140329 the same with DMP FIFO output rate Damm Stanger
...
#define MPU6050_RA_INT_PIN_CFG      0x37			//中断和管脚配置
#define MPU6050_RA_INT_ENABLE       0x38
#define MPU6050_RA_DMP_INT_STATUS   0x39
#define MPU6050_RA_INT_STATUS       0x3A
#define MPU6050_RA_ACCEL_XOUT_H     0x3B			//X轴加速度数据寄存器高位
...
#define MPU6050_RA_WHO_AM_I         0x75	//IIC地址寄存器(默认数值0x68，9脚AD0接高时为0x69只读)


#define MPU6050_ADDRESS_AD0_LOW     0x68 // address pin low (GND), default for InvenSense evaluation board
#define MPU6050_ADDRESS_AD0_HIGH    0x69 // address pin high (VCC)
#define MPU6050_DEFAULT_ADDRESS     (MPU6050_ADDRESS_AD0_LOW<<1)	//0x68<<1  IIC写入时的地址字节数据，+1为读取
